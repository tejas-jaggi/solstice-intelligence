...
SUCCESS_BODY = {
    ...
    "metadata": {"request_id": "abc", "stage": "completed", "execution_time_ms": 1.2,
                 "row_count": 1, "truncated": False, "validation_passed": True},
}
...
def test_rejection_is_apiresult_not_error():
    body = {"status": "validation_rejected", "success": False, "answer": None,
            "explanation": "not permitted", "executed_sql": None,
